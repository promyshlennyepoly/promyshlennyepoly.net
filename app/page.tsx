  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="section shell seo-section" aria-labelledby="industrial-floors-title">
          <div>
            <p className="eyebrow">Полезно знать</p>
            <h2 id="industrial-floors-title">Промышленные бетонные полы в Беларуси</h2>
          </div>
          <div className="seo-copy">
            <p>
              Промышленный бетонный пол — это рассчитанная конструкция для
              складов, производственных цехов, логистических комплексов,
              паркингов и других объектов с высокой нагрузкой. В отличие от
              обычной стяжки, такая плита учитывает движение погрузчиков,
              давление стеллажей и оборудования, требования к ровности,
              истираемости и беспыльности поверхности. Для условий Беларуси
              также важны температурные перепады, влажность и воздействие
              противогололёдных реагентов во въездных зонах.
            </p>
            <p>
              Надёжность пола зависит от всей технологии устройства: подготовки
              и уплотнения основания, марки бетона, армирования, правильной
              укладки смеси, нарезки швов и финишной обработки. Верхний слой
              можно упрочнить топпингом или защитить полимерным покрытием — выбор
              делают по реальным механическим и химическим нагрузкам. В
              материалах блога мы подробно разбираем эти решения, типичные
              дефекты бетонных полов, способы ремонта и правила дальнейшей
              эксплуатации.
            </p>
          </div>
        </section>
